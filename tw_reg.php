...
if(!empty($_POST["register-user"])) {
	...
	if(!isset($error_message)) {
		...
		$query = "INSERT INTO tw_customer (TITLE, FIRSTNAME, LASTNAME, AGE, REG_NO, REGIS_DATE, CHASSIS_NUM, ENGINE_NUMB, MANF_NAME, MODEL, MANFT_YEAR, MOBILE_NUMBER, EMAIL, ADDRESS) VALUES ('$a', '$b', '$c', '$d', '$e', '$f', '$g', '$h', '$i', '$o', '$j', '$k', '$l', '$m');";
