...
if(!empty($_POST["register-user"])) {
	...
	if(!isset($error_message)) {
		...
		$query = "INSERT INTO fw_insurance (REQUEST_FOR, POLICY, TITLE, FIRSTNAME, LASTNAME, AGE, REG_NO, REGIS_DATE, CHASSIS_NUM, ENGINE_NUMB, MANF_NAME, MODEL, MANFT_YEAR, VECHILE_TYPE, MOBILE_NUMBER, EMAIL, ADDRESS) VALUES ('$s', '$p', '$a', '$b', '$c', '$d', '$e', '$f', '$g', '$h', '$i', '$o', '$j', '$q', '$k', '$l', '$m');";
